...
TODO: possivelmente melhorar/aumentar essa subsecao.
...
TODO: adicionar teorema do hiperplano.

In other words, the theorem above states that the optimal partition can be obtained by choosing the right hyperplane. This motivates the PC criterion, which look at the hyperplanes in $\mathbb{R}^k$ whose normal vector is the principal direction of the attribute's contingency table.
...
It is also proved that there is no other way of grouping classes into superclasses that has a smaller approximation guarantee for the Gini impurity. It can also be used with the Information Gain impurity, instead of Gini Gain, but its approximation guarantee increases to 3 (TODO: conferir). These bounds are all proved in (TODO: ver como colocar referencia).
...
It is also proved that, for the entropy impurity, the best form of grouping classes into superclasses is by balancing them the best way possible. See (TODO: ver como colocar referencia) for more details.
