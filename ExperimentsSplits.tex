...
%SLIQ-ext, 
Largest Alone and List Scheduling for both the Gini and Entropy impurities. Note that we don't evaluate Twoing because the split selected by Hypercube Cover is always purer by construction.
...
In general, we observe an advantage for Hypercube Cover with both impurities, being more clear for the Entropy, followed by PC-ext. This suggests that the Largest Alone and List Scheduling heuristics are not competitive with them in terms of split impurity found.

TODO: colocar tabela de tempos?

TODO: colocar tabela comparando impureza do Hypercube Cover e PC-ext?
